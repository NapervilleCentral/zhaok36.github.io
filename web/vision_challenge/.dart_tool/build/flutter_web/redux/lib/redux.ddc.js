define(['dart_sdk'], function(dart_sdk) {
  ...
  dart.defineLazy(CT, {
    get C0() {
      return C0 = dart.constList([], StoreOfObjectAnddynamicAndFnTovoid());
    }
  });
  ...
  store.Store$ = dart.generic(State => {
    ...
    class Store extends core.Object {
      ...
      [_createDispatchers](middleware, reduceAndNotify) {
        let t0;
        let dispatchers = (t0 = JSArrayOfdynamicTovoid().of([]), t0[$add](reduceAndNotify), t0);
    ...
    dart.setMethodSignature(Store, () => ({
      ...
      [_createDispatchers]: dart.fnType(core.List$(dart.fnType(dart.void, [dart.dynamic])), [core.List$(dart.fnType(dart.void, [store.Store$(State), dart.dynamic, dart.fnType(dart.void, [dart.dynamic])])), dart.fnType(dart.void, [dart.dynamic])]),
    ...
    dart.setFieldSignature(Store, () => ({
      ...
      [_dispatchers]: dart.fieldType(core.List$(dart.fnType(dart.void, [dart.dynamic])))
    }));
    return Store;
  });
  ...
  utils.TypedMiddleware$ = dart.generic((State, Action) => {
    ...
    dart.setFieldSignature(TypedMiddleware, () => ({
      ...
      middleware: dart.finalFieldType(dart.fnType(dart.void, [store.Store$(State), Action, dart.fnType(dart.void, [dart.dynamic])]))
    }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["src/store.dart","src/utils.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;IAgDA;;;;;;;;;;;;;IAqDA;;;;;;;;;;;;;;;;;;;;MAsDiB;;;;;;;AA6BI;MAAM;;AAwBK,cAAA,AAAkB;MAAM;+BAOX;AACzC,cAAO,SAAS;AACR,sBAAQ,aAAQ,cAAQ,MAAM;AAEpC,wBAAI,QAAQ,KAAU,YAAN,KAAK,EAAI,eAAQ;AAEnB,UAAd,eAAS,KAAK;AACc,UAA5B,AAAkB,4BAAI,KAAK;;MAE/B;2BAG0B,YACT;;AAET,gCAA8B,iCAAI,SAAI,eAAe;AAG3D,iBAAS,iBAAkB,AAAW,WAAD;AAC7B,qBAAO,AAAY,WAAD;AAIvB,UAFD,AAAY,WAAD,OACT,QAAS,UAAW,AAAc,cAAA,CAAC,MAAM,MAAM,EAAE,IAAI;;AAIzD,cAAO,AAAY,AAAS,YAAV;MACpB;eAMsB;AACG,QAAvB,AAAY,AAAG,0BAAF,GAAG,MAAM;MACxB;;AAMe;AACA,UAAb,eAAS;AACT,gBAAO,AAAkB;QAC3B;;;0BAjGO;UACC;UACkB;UACnB;UAQA;MAfD;MACe;MAGd;MAaiB,0BAAM,2CAAiC,UAAU;AAClD,MAArB,eAAS,YAAY;AAIpB,MAHD,qBAAe,yBACb,UAAU,EACV,6BAAuB,QAAQ;IAEnC;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MCtFiD;;;;;;WAKhC,OAAe;qBAAf;AACf,YAAW,UAAP,MAAM;AACR,gBAAO,cAAQ,KAAK,EAAE,MAAM;;AAG9B,cAAO,MAAK;MACd;;;MATkB;;IAAQ;;;;;;;;;;;;;;;;;;;;;;MAiHxB;;;;;;WAKqB,OAAe,QAAuB;8BAAtC;AACrB,YAAW,UAAP,MAAM;AACuB,UAA/B,gBAAW,KAAK,EAAE,MAAM,EAAE,IAAI;;AAElB,UAAZ,AAAI,IAAA,CAAC,MAAM;;MAEf;;;MATqB;;IAAW;;;;;;;;;;;;;;;;;0DAgC6B;AAC7D,UAAO,UAAO,OAAe;AAC3B,eAAW,UAAW,SAAQ;AACE,QAA9B,QAAQ,AAAO,OAAA,CAAC,KAAK,EAAE,MAAM;;AAE/B,YAAO,MAAK;;EAEhB","file":"redux.ddc.js"}');
  // Exports:
  return {
    src__store: store,
    redux: redux,
