define(['dart_sdk', 'packages/vision_challenge/main'], function(dart_sdk, packages__vision_challenge__main) {
  'use strict';
  ...
  const main = packages__vision_challenge__main.main;
  ...
  dart.trackLibraries("packages/vision_challenge/main_web_entrypoint", {
    "package:vision_challenge/main_web_entrypoint.dart": main_web_entrypoint
  }, {
