...
let modulePaths = {
 ...
 "packages/flutter_redux/flutter_redux": "packages/flutter_redux/flutter_redux.ddc",
 ...
 "packages/vision_challenge/game": "packages/vision_challenge/game.ddc",
 "packages/vision_challenge/main": "packages/vision_challenge/main.ddc",
 "packages/vision_challenge/main_web_entrypoint": "packages/vision_challenge/main_web_entrypoint.ddc"
};
...
define("main_web_entrypoint.dart.bootstrap", ["packages/vision_challenge/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:vision_challenge/main_web_entrypoint.dart") {
          // Clear static caches.
