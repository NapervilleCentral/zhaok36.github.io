define(['dart_sdk', 'packages/test_project/main'], function(dart_sdk, packages__test_project__main) {
  'use strict';
  ...
  const main = packages__test_project__main.main;
  ...
  dart.trackLibraries("packages/test_project/main_web_entrypoint", {
    "package:test_project/main_web_entrypoint.dart": main_web_entrypoint
  }, {
