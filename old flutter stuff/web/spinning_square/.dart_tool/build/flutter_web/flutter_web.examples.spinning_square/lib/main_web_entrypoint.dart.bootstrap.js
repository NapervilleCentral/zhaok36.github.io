...
let modulePaths = {
 ...
 "packages/flutter_web.examples.spinning_square/main_web_entrypoint": "packages/flutter_web.examples.spinning_square/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/flutter_web.examples.spinning_square/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:flutter_web.examples.spinning_square/main_web_entrypoint.dart") {
          // Clear static caches.
