...
let modulePaths = {
 ...
 "packages/dad_jokes/auto_size_text": "packages/dad_jokes/auto_size_text.ddc",
 "packages/dad_jokes/main": "packages/dad_jokes/main.ddc",
 "packages/dad_jokes/main_page": "packages/dad_jokes/main_page.ddc",
 "packages/dad_jokes/main_web_entrypoint": "packages/dad_jokes/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/dad_jokes/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:dad_jokes/main_web_entrypoint.dart") {
          // Clear static caches.
