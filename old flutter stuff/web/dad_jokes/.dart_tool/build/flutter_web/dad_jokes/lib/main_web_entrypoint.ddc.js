define(['dart_sdk', 'packages/dad_jokes/main'], function(dart_sdk, packages__dad_jokes__main) {
  'use strict';
  ...
  const main = packages__dad_jokes__main.main;
  ...
  dart.trackLibraries("packages/dad_jokes/main_web_entrypoint", {
    "package:dad_jokes/main_web_entrypoint.dart": main_web_entrypoint
  }, {
